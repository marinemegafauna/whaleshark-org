...
import type { WorkbenchEncounter } from '../lib/wildbook';

export type MockEncounter = WorkbenchEncounter;
...
export const mockEncounters: MockEncounter[] = [
  ...
  mockEncounter({ id: 'e92bc110', individualId: 'TZ-117', sightings: 6, date: '5 Aug 2026', photographer: 'M. Hassan', sex: 'F', size: '~6 m', photos: '4 · L+R', siteId: 'mafia-island', image: '/mock/whale-shark-2.svg', imageFilename: 'IMG_4477.JPG' }),
  mockEncounter({ id: 'f04ad281', individualId: 'MZ-284', sightings: 14, date: '2 Aug 2026', photographer: 'A. Said', sex: 'M', size: '~7 m', photos: '2 · L', siteId: 'mafia-island', image: '/mock/whale-shark-1.svg', imageFilename: 'IMG_4478.JPG' }),
];
